...
class PatientController extends Controller {
    ...
    public function store(Request $r): JsonResponse {
        $data=$r->validate([
            'name'=>'required|string|max:255','nik'=>'required|string|size:16|unique:patients',
            'phone'=>'required|string|max:20','birth_date'=>'required|date',
    ...
    public function update(Request $r, Patient $patient): JsonResponse {
        $data=$r->validate(['name'=>'sometimes|string','phone'=>'sometimes|string','birth_date'=>'sometimes|date','gender'=>'sometimes|in:L,P','blood_type'=>'nullable','address'=>'sometimes|string','allergies'=>'nullable|string','chronic_diseases'=>'nullable|string']);
        $patient->update($data);
