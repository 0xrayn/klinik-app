    ...
    return (
        <div className="space-y-6 animate-slide-up">
            ...
            <div className="flex items-start justify-between gap-4">
                <div>
                    <h1 className="text-xl font-bold text-slate-900 dark:text-white font-display">{greet()}, {displayName()} 👋</h1>
                ...
                <Card className="p-5 lg:col-span-3">
                    ...
                    <ResponsiveContainer width="100%" height={170}>
                        <AreaChart data={weekTrend} margin={{ top:4, right:4, left:-24, bottom:0 }}>
                            ...
                            <Area type="monotone" dataKey="n" stroke="#2563eb" strokeWidth={2} fill="url(#gBrand)"
                ...
                <Card className="p-5 lg:col-span-2">
                    ...
                    <ResponsiveContainer width="100%" height={170}>
                        <BarChart data={monthTrend} margin={{ top:4, right:4, left:-24, bottom:0 }}>
                            ...
                            <Bar dataKey="n" fill="#0ea5e9" radius={[5,5,0,0]} maxBarSize={28} />
                        </BarChart>
                    </ResponsiveContainer>
                </Card>
            </div>
                                    ...
                                    <tr key={a.id} className="tbl-row">
                                        <td className="tbl-cell">
                                            <div className="flex items-center gap-2.5">
                                                ...
                                                <span className="font-medium text-slate-800 dark:text-slate-200">{a.patient}</span>
                                            </div>
                                        </td>
                                        <td className="tbl-cell text-slate-500 text-xs">{a.doctor}</td>
                                        <td className="tbl-cell">
                                            <span className="text-xs bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 px-2 py-0.5 rounded-lg font-medium">{a.poli}</span>
                                        </td>
                                        <td className="tbl-cell font-mono text-xs font-semibold dark:text-slate-200">{a.time}</td>
                                        <td className="tbl-cell">
