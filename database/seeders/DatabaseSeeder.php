...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ── 4. Doctors ────────────────────────────────────────────────────────
        $this->command->info('👨‍⚕️ Membuat dokter...');
        $doctorsData = [
            [
                'user'   => ['name' => 'dr. Siti Rahayu, Sp.PD',   'email' => 'dokter@klinik.id',    'phone' => '081200000010'],
                'doctor' => ['specialization' => 'Penyakit Dalam', 'license_number' => 'SIP-001/2020', 'experience_years' => 12, 'consultation_fee' => 150000, 'rating' => 4.8, 'total_reviews' => 234,
            ...
            [
                ...
                'doctor' => ['specialization' => 'Gigi & Mulut',   'license_number' => 'SIP-002/2020', 'experience_years' => 8,  'consultation_fee' => 120000, 'rating' => 4.7, 'total_reviews' => 189,
            ...
            [
                ...
                'doctor' => ['specialization' => 'Anak',           'license_number' => 'SIP-003/2020', 'experience_years' => 15, 'consultation_fee' => 175000, 'rating' => 4.9, 'total_reviews' => 312,
            ...
            [
                ...
                'doctor' => ['specialization' => 'Jantung',        'license_number' => 'SIP-004/2020', 'experience_years' => 20, 'consultation_fee' => 250000, 'rating' => 4.6, 'total_reviews' => 156,
            ...
            [
                ...
                'doctor' => ['specialization' => 'Mata',           'license_number' => 'SIP-005/2020', 'experience_years' => 10, 'consultation_fee' => 140000, 'rating' => 4.8, 'total_reviews' => 201,
